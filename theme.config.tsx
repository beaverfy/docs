...
const config: DocsThemeConfig = {
  docsRepositoryBase: 'https://github.com/beaverfy/docs', // base URL for the docs repository
  darkMode: true,
  primaryHue: {
    dark: 150.00,
    light: 150.00
  ...
  project: {
    link: "https://github.com/beaverfy/docs"
  },
  footer: {
  ...
  head: (
    <>
      ...
      <meta
        name="description"
        content="An organization run by beavers! 🦫"
      />
      <meta name="og:title" content="Beaverfy" />
    </>
  ),
  toc: {
    backToTop: true,
